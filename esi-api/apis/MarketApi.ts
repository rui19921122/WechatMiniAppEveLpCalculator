...
export class MarketApi extends runtime.BaseAPI {
     ...
     */
    async getCharactersCharacterIdOrdersRaw(requestParameters: GetCharactersCharacterIdOrdersRequest): Promise<runtime.ApiResponse<Array<GetCharactersCharacterIdOrders200Ok>>> {
        ...
        if (this.configuration && this.configuration.accessToken) {
            ...
            if (typeof this.configuration.accessToken === 'function') {
                headerParameters["Authorization"] = this.configuration.accessToken("evesso", ["esi-markets.read_character_orders.v1"]);
            } else {
     ...
     * List open orders from a character
     */
    async getCharactersCharacterIdOrders(requestParameters: GetCharactersCharacterIdOrdersRequest): Promise<Array<GetCharactersCharacterIdOrders200Ok>> {
        const response = await this.getCharactersCharacterIdOrdersRaw(requestParameters);
     ...
     */
    async getCharactersCharacterIdOrdersHistoryRaw(requestParameters: GetCharactersCharacterIdOrdersHistoryRequest): Promise<runtime.ApiResponse<Array<GetCharactersCharacterIdOrdersHistory200Ok>>> {
        if (requestParameters.characterId === null || requestParameters.characterId === undefined) {
     ...
     * List historical orders by a character
     */
    async getCharactersCharacterIdOrdersHistory(requestParameters: GetCharactersCharacterIdOrdersHistoryRequest): Promise<Array<GetCharactersCharacterIdOrdersHistory200Ok>> {
        const response = await this.getCharactersCharacterIdOrdersHistoryRaw(requestParameters);
        return await response.value();
    }
     ...
     */
    async getCorporationsCorporationIdOrdersRaw(requestParameters: GetCorporationsCorporationIdOrdersRequest): Promise<runtime.ApiResponse<Array<GetCorporationsCorporationIdOrders200Ok>>> {
        ...
        if (this.configuration && this.configuration.accessToken) {
            // oauth required
            if (typeof this.configuration.accessToken === 'function') {
                headerParameters["Authorization"] = this.configuration.accessToken("evesso", ["esi-markets.read_corporation_orders.v1"]);
            } else {
                headerParameters["Authorization"] = this.configuration.accessToken;
            }
        }
     ...
     * List open orders from a corporation
     */
    async getCorporationsCorporationIdOrders(requestParameters: GetCorporationsCorporationIdOrdersRequest): Promise<Array<GetCorporationsCorporationIdOrders200Ok>> {
        const response = await this.getCorporationsCorporationIdOrdersRaw(requestParameters);
        return await response.value();
    }
     ...
     */
    async getCorporationsCorporationIdOrdersHistoryRaw(requestParameters: GetCorporationsCorporationIdOrdersHistoryRequest): Promise<runtime.ApiResponse<Array<GetCorporationsCorporationIdOrdersHistory200Ok>>> {
        if (requestParameters.corporationId === null || requestParameters.corporationId === undefined) {
     ...
     * List historical orders from a corporation
     */
    async getCorporationsCorporationIdOrdersHistory(requestParameters: GetCorporationsCorporationIdOrdersHistoryRequest): Promise<Array<GetCorporationsCorporationIdOrdersHistory200Ok>> {
        const response = await this.getCorporationsCorporationIdOrdersHistoryRaw(requestParameters);
        return await response.value();
    }
     ...
     * Get item groups
     */
    async getMarketsGroupsRaw(requestParameters: GetMarketsGroupsRequest): Promise<runtime.ApiResponse<Array<number>>> {
        const queryParameters: runtime.HTTPQuery = {};
     ...
     * Get item groups
     */
    async getMarketsGroups(requestParameters: GetMarketsGroupsRequest): Promise<Array<number>> {
        const response = await this.getMarketsGroupsRaw(requestParameters);
        return await response.value();
    }
     ...
     */
    async getMarketsGroupsMarketGroupIdRaw(requestParameters: GetMarketsGroupsMarketGroupIdRequest): Promise<runtime.ApiResponse<GetMarketsGroupsMarketGroupIdOk>> {
     ...
     * Get item group information
     */
    async getMarketsGroupsMarketGroupId(requestParameters: GetMarketsGroupsMarketGroupIdRequest): Promise<GetMarketsGroupsMarketGroupIdOk> {
        const response = await this.getMarketsGroupsMarketGroupIdRaw(requestParameters);
        return await response.value();
    }
     ...
     * List market prices
     */
    async getMarketsPricesRaw(requestParameters: GetMarketsPricesRequest): Promise<runtime.ApiResponse<Array<GetMarketsPrices200Ok>>> {
        const queryParameters: runtime.HTTPQuery = {};
     ...
     * List market prices
     */
    async getMarketsPrices(requestParameters: GetMarketsPricesRequest): Promise<Array<GetMarketsPrices200Ok>> {
        const response = await this.getMarketsPricesRaw(requestParameters);
        return await response.value();
    }
     ...
     */
    async getMarketsRegionIdHistoryRaw(requestParameters: GetMarketsRegionIdHistoryRequest): Promise<runtime.ApiResponse<Array<GetMarketsRegionIdHistory200Ok>>> {
     ...
     * List historical market statistics in a region
     */
    async getMarketsRegionIdHistory(requestParameters: GetMarketsRegionIdHistoryRequest): Promise<Array<GetMarketsRegionIdHistory200Ok>> {
        const response = await this.getMarketsRegionIdHistoryRaw(requestParameters);
        return await response.value();
    }
     ...
     */
    async getMarketsRegionIdOrdersRaw(requestParameters: GetMarketsRegionIdOrdersRequest): Promise<runtime.ApiResponse<Array<GetMarketsRegionIdOrders200Ok>>> {
     ...
     * List orders in a region
     */
    async getMarketsRegionIdOrders(requestParameters: GetMarketsRegionIdOrdersRequest): Promise<Array<GetMarketsRegionIdOrders200Ok>> {
        const response = await this.getMarketsRegionIdOrdersRaw(requestParameters);
        return await response.value();
    }
     ...
     */
    async getMarketsRegionIdTypesRaw(requestParameters: GetMarketsRegionIdTypesRequest): Promise<runtime.ApiResponse<Array<number>>> {
        if (requestParameters.regionId === null || requestParameters.regionId === undefined) {
     ...
     * List type IDs relevant to a market
     */
    async getMarketsRegionIdTypes(requestParameters: GetMarketsRegionIdTypesRequest): Promise<Array<number>> {
        const response = await this.getMarketsRegionIdTypesRaw(requestParameters);
        return await response.value();
    }
     ...
     */
    async getMarketsStructuresStructureIdRaw(requestParameters: GetMarketsStructuresStructureIdRequest): Promise<runtime.ApiResponse<Array<GetMarketsStructuresStructureId200Ok>>> {
        ...
        if (this.configuration && this.configuration.accessToken) {
            // oauth required
            if (typeof this.configuration.accessToken === 'function') {
                headerParameters["Authorization"] = this.configuration.accessToken("evesso", ["esi-markets.structure_markets.v1"]);
            } else {
                headerParameters["Authorization"] = this.configuration.accessToken;
            }
        }
     ...
     * List orders in a structure
     */
    async getMarketsStructuresStructureId(requestParameters: GetMarketsStructuresStructureIdRequest): Promise<Array<GetMarketsStructuresStructureId200Ok>> {
        const response = await this.getMarketsStructuresStructureIdRaw(requestParameters);
        return await response.value();
    }
...
/**
    ...
    * @enum {string}
    */
export enum GetCharactersCharacterIdOrdersDatasourceEnum {
    Serenity = 'serenity'
}
/**
    * @export
    * @enum {string}
    */
export enum GetCharactersCharacterIdOrdersHistoryDatasourceEnum {
    Serenity = 'serenity'
}
/**
    * @export
    * @enum {string}
    */
export enum GetCorporationsCorporationIdOrdersDatasourceEnum {
    Serenity = 'serenity'
}
/**
    * @export
    * @enum {string}
    */
export enum GetCorporationsCorporationIdOrdersHistoryDatasourceEnum {
    Serenity = 'serenity'
}
/**
    * @export
    * @enum {string}
    */
export enum GetMarketsGroupsDatasourceEnum {
    Serenity = 'serenity'
}
/**
    * @export
...
/**
    ...
    * @enum {string}
    */
export enum GetMarketsGroupsMarketGroupIdDatasourceEnum {
    Serenity = 'serenity'
}
/**
    * @export
    * @enum {string}
    */
export enum GetMarketsGroupsMarketGroupIdLanguageEnum {
    EnUs = 'en-us',
    Zh = 'zh'
}
/**
    ...
    * @enum {string}
    */
export enum GetMarketsPricesDatasourceEnum {
    Serenity = 'serenity'
}
/**
    * @export
    * @enum {string}
    */
export enum GetMarketsRegionIdHistoryDatasourceEnum {
    Serenity = 'serenity'
}
/**
    * @export
...
/**
    ...
    * @enum {string}
    */
export enum GetMarketsRegionIdOrdersDatasourceEnum {
    Serenity = 'serenity'
}
/**
    * @export
    * @enum {string}
    */
export enum GetMarketsRegionIdTypesDatasourceEnum {
    Serenity = 'serenity'
}
/**
    * @export
    * @enum {string}
    */
export enum GetMarketsStructuresStructureIdDatasourceEnum {
    Serenity = 'serenity'
}
