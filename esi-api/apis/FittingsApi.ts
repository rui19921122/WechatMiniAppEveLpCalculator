...
export class FittingsApi extends runtime.BaseAPI {
     ...
     * Delete fitting
     */
    async deleteCharactersCharacterIdFittingsFittingIdRaw(requestParameters: DeleteCharactersCharacterIdFittingsFittingIdRequest): Promise<runtime.ApiResponse<void>> {
        ...
        if (this.configuration && this.configuration.accessToken) {
            ...
            if (typeof this.configuration.accessToken === 'function') {
                headerParameters["Authorization"] = this.configuration.accessToken("evesso", ["esi-fittings.write_fittings.v1"]);
            } else {
     ...
     * Delete fitting
     */
    async deleteCharactersCharacterIdFittingsFittingId(requestParameters: DeleteCharactersCharacterIdFittingsFittingIdRequest): Promise<void> {
        await this.deleteCharactersCharacterIdFittingsFittingIdRaw(requestParameters);
    }
     ...
     * Get fittings
     */
    async getCharactersCharacterIdFittingsRaw(requestParameters: GetCharactersCharacterIdFittingsRequest): Promise<runtime.ApiResponse<Array<GetCharactersCharacterIdFittings200Ok>>> {
        if (requestParameters.characterId === null || requestParameters.characterId === undefined) {
        ...
        if (this.configuration && this.configuration.accessToken) {
            // oauth required
            if (typeof this.configuration.accessToken === 'function') {
                headerParameters["Authorization"] = this.configuration.accessToken("evesso", ["esi-fittings.read_fittings.v1"]);
            } else {
                headerParameters["Authorization"] = this.configuration.accessToken;
            }
        }
     ...
     * Get fittings
     */
    async getCharactersCharacterIdFittings(requestParameters: GetCharactersCharacterIdFittingsRequest): Promise<Array<GetCharactersCharacterIdFittings200Ok>> {
        const response = await this.getCharactersCharacterIdFittingsRaw(requestParameters);
     ...
     * Create fitting
     */
    async postCharactersCharacterIdFittingsRaw(requestParameters: PostCharactersCharacterIdFittingsRequest): Promise<runtime.ApiResponse<PostCharactersCharacterIdFittingsCreated>> {
        if (requestParameters.characterId === null || requestParameters.characterId === undefined) {
     ...
     * Create fitting
     */
    async postCharactersCharacterIdFittings(requestParameters: PostCharactersCharacterIdFittingsRequest): Promise<PostCharactersCharacterIdFittingsCreated> {
        const response = await this.postCharactersCharacterIdFittingsRaw(requestParameters);
        return await response.value();
    }
...
/**
    ...
    * @enum {string}
    */
export enum DeleteCharactersCharacterIdFittingsFittingIdDatasourceEnum {
    Serenity = 'serenity'
}
/**
    * @export
    * @enum {string}
    */
export enum GetCharactersCharacterIdFittingsDatasourceEnum {
    Serenity = 'serenity'
}
/**
    * @export
    * @enum {string}
    */
export enum PostCharactersCharacterIdFittingsDatasourceEnum {
    Serenity = 'serenity'
}
