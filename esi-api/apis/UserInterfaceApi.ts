...
export class UserInterfaceApi extends runtime.BaseAPI {
     ...
     */
    async postUiAutopilotWaypointRaw(requestParameters: PostUiAutopilotWaypointRequest): Promise<runtime.ApiResponse<void>> {
        ...
        if (this.configuration && this.configuration.accessToken) {
            ...
            if (typeof this.configuration.accessToken === 'function') {
                headerParameters["Authorization"] = this.configuration.accessToken("evesso", ["esi-ui.write_waypoint.v1"]);
            } else {
     ...
     * Set Autopilot Waypoint
     */
    async postUiAutopilotWaypoint(requestParameters: PostUiAutopilotWaypointRequest): Promise<void> {
        await this.postUiAutopilotWaypointRaw(requestParameters);
    }
     ...
     */
    async postUiOpenwindowContractRaw(requestParameters: PostUiOpenwindowContractRequest): Promise<runtime.ApiResponse<void>> {
        ...
        if (this.configuration && this.configuration.accessToken) {
            // oauth required
            if (typeof this.configuration.accessToken === 'function') {
                headerParameters["Authorization"] = this.configuration.accessToken("evesso", ["esi-ui.open_window.v1"]);
            } else {
                headerParameters["Authorization"] = this.configuration.accessToken;
            }
        }
     ...
     * Open Contract Window
     */
    async postUiOpenwindowContract(requestParameters: PostUiOpenwindowContractRequest): Promise<void> {
        await this.postUiOpenwindowContractRaw(requestParameters);
    }
     ...
     */
    async postUiOpenwindowInformationRaw(requestParameters: PostUiOpenwindowInformationRequest): Promise<runtime.ApiResponse<void>> {
     ...
     * Open Information Window
     */
    async postUiOpenwindowInformation(requestParameters: PostUiOpenwindowInformationRequest): Promise<void> {
        await this.postUiOpenwindowInformationRaw(requestParameters);
    }
     ...
     * Open Market Details
     */
    async postUiOpenwindowMarketdetailsRaw(requestParameters: PostUiOpenwindowMarketdetailsRequest): Promise<runtime.ApiResponse<void>> {
     ...
     * Open Market Details
     */
    async postUiOpenwindowMarketdetails(requestParameters: PostUiOpenwindowMarketdetailsRequest): Promise<void> {
        await this.postUiOpenwindowMarketdetailsRaw(requestParameters);
    }
     ...
     */
    async postUiOpenwindowNewmailRaw(requestParameters: PostUiOpenwindowNewmailRequest): Promise<runtime.ApiResponse<void>> {
     ...
     * Open New Mail Window
     */
    async postUiOpenwindowNewmail(requestParameters: PostUiOpenwindowNewmailRequest): Promise<void> {
        await this.postUiOpenwindowNewmailRaw(requestParameters);
    }
...
/**
    ...
    * @enum {string}
    */
export enum PostUiAutopilotWaypointDatasourceEnum {
    Serenity = 'serenity'
}
/**
    * @export
    * @enum {string}
    */
export enum PostUiOpenwindowContractDatasourceEnum {
    Serenity = 'serenity'
}
/**
    * @export
    * @enum {string}
    */
export enum PostUiOpenwindowInformationDatasourceEnum {
    Serenity = 'serenity'
}
/**
    * @export
    * @enum {string}
    */
export enum PostUiOpenwindowMarketdetailsDatasourceEnum {
    Serenity = 'serenity'
}
/**
    * @export
    * @enum {string}
    */
export enum PostUiOpenwindowNewmailDatasourceEnum {
    Serenity = 'serenity'
}
