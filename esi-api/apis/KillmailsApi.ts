...
export class KillmailsApi extends runtime.BaseAPI {
     ...
     */
    async getCharactersCharacterIdKillmailsRecentRaw(requestParameters: GetCharactersCharacterIdKillmailsRecentRequest): Promise<runtime.ApiResponse<Array<GetCharactersCharacterIdKillmailsRecent200Ok>>> {
        ...
        if (this.configuration && this.configuration.accessToken) {
            ...
            if (typeof this.configuration.accessToken === 'function') {
                headerParameters["Authorization"] = this.configuration.accessToken("evesso", ["esi-killmails.read_killmails.v1"]);
            } else {
     ...
     * Get a character\'s recent kills and losses
     */
    async getCharactersCharacterIdKillmailsRecent(requestParameters: GetCharactersCharacterIdKillmailsRecentRequest): Promise<Array<GetCharactersCharacterIdKillmailsRecent200Ok>> {
        const response = await this.getCharactersCharacterIdKillmailsRecentRaw(requestParameters);
     ...
     */
    async getCorporationsCorporationIdKillmailsRecentRaw(requestParameters: GetCorporationsCorporationIdKillmailsRecentRequest): Promise<runtime.ApiResponse<Array<GetCorporationsCorporationIdKillmailsRecent200Ok>>> {
        ...
        if (this.configuration && this.configuration.accessToken) {
            // oauth required
            if (typeof this.configuration.accessToken === 'function') {
                headerParameters["Authorization"] = this.configuration.accessToken("evesso", ["esi-killmails.read_corporation_killmails.v1"]);
            } else {
                headerParameters["Authorization"] = this.configuration.accessToken;
            }
        }
     ...
     * Get a corporation\'s recent kills and losses
     */
    async getCorporationsCorporationIdKillmailsRecent(requestParameters: GetCorporationsCorporationIdKillmailsRecentRequest): Promise<Array<GetCorporationsCorporationIdKillmailsRecent200Ok>> {
        const response = await this.getCorporationsCorporationIdKillmailsRecentRaw(requestParameters);
        return await response.value();
    }
     ...
     */
    async getKillmailsKillmailIdKillmailHashRaw(requestParameters: GetKillmailsKillmailIdKillmailHashRequest): Promise<runtime.ApiResponse<GetKillmailsKillmailIdKillmailHashOk>> {
     ...
     * Get a single killmail
     */
    async getKillmailsKillmailIdKillmailHash(requestParameters: GetKillmailsKillmailIdKillmailHashRequest): Promise<GetKillmailsKillmailIdKillmailHashOk> {
        const response = await this.getKillmailsKillmailIdKillmailHashRaw(requestParameters);
        return await response.value();
    }
...
/**
    ...
    * @enum {string}
    */
export enum GetCharactersCharacterIdKillmailsRecentDatasourceEnum {
    Serenity = 'serenity'
}
/**
    * @export
    * @enum {string}
    */
export enum GetCorporationsCorporationIdKillmailsRecentDatasourceEnum {
    Serenity = 'serenity'
}
/**
    * @export
    * @enum {string}
    */
export enum GetKillmailsKillmailIdKillmailHashDatasourceEnum {
    Serenity = 'serenity'
}
