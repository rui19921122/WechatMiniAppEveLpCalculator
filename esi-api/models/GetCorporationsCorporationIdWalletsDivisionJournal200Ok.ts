...
* @enum {string}
*/
export enum GetCorporationsCorporationIdWalletsDivisionJournal200OkContextIdTypeEnum {
...
* @enum {string}
*/
export enum GetCorporationsCorporationIdWalletsDivisionJournal200OkRefTypeEnum {
