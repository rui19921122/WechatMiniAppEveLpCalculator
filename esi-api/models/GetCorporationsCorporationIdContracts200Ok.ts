...
* @enum {string}
*/
export enum GetCorporationsCorporationIdContracts200OkAvailabilityEnum {
    Public = 'public',
    Personal = 'personal',
...
* @enum {string}
*/
export enum GetCorporationsCorporationIdContracts200OkStatusEnum {
...
* @enum {string}
*/
export enum GetCorporationsCorporationIdContracts200OkTypeEnum {
    Unknown = 'unknown',
