...
export function PostCharactersCharacterIdFittingsItemToJSON(value?: PostCharactersCharacterIdFittingsItem | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
* @enum {string}
*/
export enum PostCharactersCharacterIdFittingsItemFlagEnum {
    Cargo = 'Cargo',
    DroneBay = 'DroneBay',
